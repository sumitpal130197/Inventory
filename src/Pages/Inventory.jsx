          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-6 mt-3">
                <div class="card income-status">
                  <div class="card-body">
                    <h4 class="card-title mb-4">Tirrent Booster</h4>
              ...
              <div class="col-lg-6 mt-3">
                <div class="card income-status">
                  <div class="card-body">
                    <h4 class="card-title mb-4">Tirrent Fuel Conditioner</h4>
                    <div class="table-responsive">
                      <table class="table align-middle table-nowrap mb-0">
                        <tbody>
                          <tr>
              ...
              <div class="col-lg-6 mt-3">
                <div class="card income-status">
                  <div class="card-body">
                    <h4 class="card-title mb-4">Tirrent TG-10</h4>
                    <div class="table-responsive">
                      <table class="table align-middle table-nowrap mb-0">
                        <tbody>
                          <tr>
